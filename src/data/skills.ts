...
export const skills: Skill[] = [
  ...
  // ── 2026 Q2 Agent Ecosystem Skills (openclaw/openclaw) ─────────────────────
  {
    author: 'openclaw',
    slug: 'a2a',
    name: 'a2a',
    description: 'A2A protocol — Agent Cards, skill discovery, and inter-agent communication',
    repo: 'openclaw/openclaw',
    path: 'skills/a2a/SKILL.md',
  ...
  },
  {
    ...
    slug: 'cloud-routines',
    name: 'cloud-routines',
    description: 'Claude Code Routines + Managed Agents — scheduled and cloud-hosted execution',
    repo: 'openclaw/openclaw',
    path: 'skills/cloud-routines/SKILL.md',
    ...
    examples: [
      ...
      'Schedule a weekly report and post it to Slack',
    ],
    setupSteps: [
  ...
  },
  {
    ...
    slug: 'agent-guard',
    name: 'agent-guard',
    description: 'Agent security — sandbox config, injection detection, permission boundaries',
    repo: 'openclaw/openclaw',
    path: 'skills/agent-guard/SKILL.md',
    install: 'clawhub install openclaw/agent-guard',
    added: '2026-04-30',
    examples: [
      'Set up permission boundaries for my agent',
      'Block my agent from executing sudo or rm -rf',
      'Scan this URL for indirect prompt injection before processing',
    ],
    setupSteps: [
  ...
  },
  {
    ...
    slug: 'mcp-registry',
    name: 'mcp-registry',
    description: 'Discover and publish MCP servers from the Registry and Smithery',
    repo: 'openclaw/openclaw',
  ...
  },
  {
    ...
    slug: 'cursor-sdk',
    name: 'cursor-sdk',
    description: 'Multi-IDE agent orchestration — Cursor SDK, Windsurf+Devin, worktree parallelism',
    repo: 'openclaw/openclaw',
    path: 'skills/cursor-sdk/SKILL.md',
    install: 'clawhub install openclaw/cursor-sdk',
    added: '2026-04-30',
    examples: [
      'Set up a Cursor SDK agent that runs tests in parallel',
      'Configure Windsurf to use Devin for cloud-based debugging',
      'Run three parallel worktrees for frontend, backend, and tests',
    ],
    setupSteps: [
